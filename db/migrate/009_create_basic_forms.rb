class CreateBasicForms < ActiveRecord::Migration
  ...
  def self.down
   ...
   #Remove this form type from the form_types table
    execute 'DELETE FROM form_types WHERE type="BasicForm"'
   #****
  end
end
